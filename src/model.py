...
class RNN(nn.Module):
    ...
    def summary(self, input_size, hidden_size, output_size, n_categories):
        ...
        total_params = 0
        layers_info = [
            ("i2h", (None, n_categories + input_size + hidden_size), (None, hidden_size), self.i2h),
            ("i2o", (None, n_categories + input_size + hidden_size), (None, output_size), self.i2o),
            ("o2o", (None, hidden_size + output_size), (None, output_size), self.o2o),
        ]

        for name, in_shape, out_shape, layer in layers_info:
            params = layer.in_features * layer.out_features + layer.out_features  # Weights + Bias
            total_params += params
